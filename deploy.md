...
```bash
git remote add origin git@github.com:eliavw/aaai20.git
git remote -v
...
```bash
git remote add origin git@github.com:eliavw/aaai20.git; git remote -v; git push origin master
```
...
```bash
conda env create -f dependencies-deploy.yaml -n aaai20
```
...
conda env update -n aaai20 -f dependencies-develop.yaml
```
...
```bash
conda activate aaai20
python -m ipykernel install --user --name aaai20 --display-name "aaai20"
```
...
1. Go to the [Travis](https://travis-ci.com/eliavw/aaai20) page of this repo.
2. See if it ran.
...
and your site should be online at; [https://eliavw.github.io/aaai20/](https://eliavw.github.io/aaai20/). 
...
> Experiments for aaai20 paper., cf. https://eliavw.github.io/aaai20
